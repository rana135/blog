            ...
            <div className="flex lg:flex-row lg:justify-between flex-col items-center justify-center py-20 px-10 gap-10">
                ...
                <div className='w-full gap-10'>
                    <div className="flex flex-row justify-center">
                        <input
                            type="text"
                            className=" text-gray-600 w-full h-16 p-2 outline-none rounded-l-lg"
                    ...
                    <span className="text-stone-500 ml-2 md:text-center">We Only send interesting and relevant emails.</span>
                </div>
            </div>
